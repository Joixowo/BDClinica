...
public:
    ...
    Paciente(int id, const std::string& nombre, const std::string& apellido, const std::string& telefono,const std::string& fecha_registro,const std::string& dpi);
    ...
    void setDpi(const std::string& dpi);
